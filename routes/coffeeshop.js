var add = function (req, res) {
    console.log('coffeeshop 모듈안에 있는 add 호출됨');
...
var list = function(req,res){
    console.log('coffeeshop 모듈안에 있는 list 호출됨');
...
var findWithin =function(req, res){
    console.log('coffeeshop 모듈안에 있는 findWithin 호출됨');
    ...
    console.log('요청파라미터 :' + paramTopLeftLongitude + ',1 ' + paramTopLeftLatitude + ',2 ' + paramBottomRightLongitude + ',3 ' + paramBottomRightLatitude);
    ...
    if(database.db){
        ...
        database.CoffeeShopModel.findWithin(paramTopLeftLongitude, paramTopLeftLatitude, paramBottomRightLongitude, paramBottomRightLatitude, function(err,results){
            ...
            if(results) {
                ...
                res.writeHead('200',{'Content-Type':'text/html;charset=utf8'});
                res.write('<h2>영역안의 커피숍 조회 실패</h2>');
                res.end();
            }
        });
    }else{
...
var findCircle = function(req,res){
    ...
    console.log('요청파라미터 :' + paramCenterLongitude + ', ' + paramCenterLatitude + ',' + paramRadius);
    ...
    if(database.db){
        ...
        database.CoffeeShopModel.findCircle(paramCenterLongitude, paramCenterLatitude, paramRadius, function(err,results){
            ...
            if(results) {
                ...
                res.writeHead('200',{'Content-Type':'text/html;charset=utf8'});
                res.write('<h2>원 영역안의 커피숍 조회 실패</h2>');
                res.end();
            }
        });
    }else{
        ...
        database.CoffeeShopModel.findNear(paramLongitude, paramLatitude, maxDistance, function(err,results){
            ...
            if(results) {
                ...
                if(results.length > 0 ) {
                    ...
                    res.writeHead('200',{'Content-Type':'text/html;charset=utf8'});
                    res.write('<h2>가까운 커피숍 데이터가 없습니다.');
                    res.end();
                }
            }else{
                res.writeHead('200',{'Content-Type':'text/html;charset=utf8'});
...
var findWithin2 =function(req, res){
    console.log('coffeeshop 모듈안에 있는 findWithin2 호출됨');
    ...
    console.log('요청파라미터 :' + paramLongitude + ', ' + paramLatitude + ', ' + paramTopLeftLongitude + ', ' + paramTopLeftLatitude + ', ' + paramBottomRightLongitude + ', ' + paramBottomRightLatitude);
    ...
    if(database.db){
        ...
        database.CoffeeShopModel.findWithin(paramTopLeftLongitude, paramTopLeftLatitude, paramBottomRightLongitude, paramBottomRightLatitude, function(err,results){
            ...
            if(results) {
                ...
                res.writeHead('200',{'Content-Type' : 'text/html;charset=utf8'});
                res.write('<h2>영역 안에 커피숍이 없습니다.</h2>');
                res.end();
            }
        }else{
            res.writeHead('200',{'Content-Type':'text/html;charset=utf8'});
